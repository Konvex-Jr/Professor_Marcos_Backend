...
class PostRepositoryDatabase {
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.length === 0)
                return null;
            return new Post_1.default(result[0].description, result[0].post_string, result[0].created_at, result[0].updated_at, null);
        });
    }
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.connection.execute("SELECT id, description, post_string, created_at, updated_at, deleted_at FROM posts;");
            // return result.map((post: Post) => new Post(post.description, post.post_string, post.created_at, post.updated_at, null));
            return result;
        });
    }
    update(post) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.connection.execute("UPDATE posts SET deleted_at = $1 WHERE id = $2;", [new Date(), id]);
