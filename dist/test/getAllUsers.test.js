...
describe("GetAllUsers UseCase", () => {
    ...
    it("deve retornar todos os usuários", () => __awaiter(void 0, void 0, void 0, function* () {
        const usersMock = [
        ...
        const useCase = new GetAllUsers_1.default(mockRepositoryFactory);
        useCase.userRepository.getAll.mockResolvedValue(usersMock);
    ...
    it("deve retornar array vazio quando não houver usuários", () => __awaiter(void 0, void 0, void 0, function* () {
        const useCase = new GetAllUsers_1.default(mockRepositoryFactory);
        useCase.userRepository.getAll.mockResolvedValue([]);
        const result = yield useCase.execute();
