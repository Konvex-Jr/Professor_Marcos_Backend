...
describe("CreatePost UseCase", () => {
  ...
  it("deve criar um post com sucesso", async () => {
    ...
    (useCase.postRepository.create as jest.Mock).mockResolvedValue({ id: "1", description: "meu primeiro post", post_string: "teste post_string", created_at: new Date(), updated_at: new Date(), deleted_at: null });
